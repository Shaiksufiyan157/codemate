...
import { PublishProblems } from "../content-table/PublishMyProblems";
export const Filter = () => {
  ...
  return (
    <>
      ...
      <div className="bg-indigo-900 rounded-t-xl p-6 shadow-sm relative">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="px-4 py-2 bg-indigo-800 text-indigo-100 border border-indigo-700 text-sm font-semibold rounded-lg hover:bg-indigo-700 transition-colors shadow-sm"
            >
              Publish List
            </button>
          ...
          <div className="flex flex-wrap gap-4 w-full sm:w-auto">
            {/* ... Your existing Data Structure Select ... */}
            ...
            {/* ... Your existing Algorithm Select ... */}
            <div className="w-full sm:w-48">
              <label className="block text-xs font-medium text-indigo-200 mb-1 uppercase tracking-wider">
                Algorithm
              </label>
